{ callPackage }:
{
  ...
  llama = callPackage (
    ...
    elpaBuild {
      pname = "llama";
      ename = "llama";
      version = "0.6.1.0.20250301.163350";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/llama-0.6.1.0.20250301.163350.tar";
        sha256 = "05xxwi87whx8c1crg582cxyfajw4r588i8zxixcjy7hj1jdpnzch";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  projectile = callPackage (
    ...
    elpaBuild {
      pname = "projectile";
      ename = "projectile";
      version = "2.9.1.0.20250215.64641";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/projectile-2.9.1.0.20250215.64641.tar";
        sha256 = "1pyai9z1jdp9f2dxl66qhxlfiz7sxdir9isq62i24v8ansad6rqh";
      };
      packageRequires = [ ];
      meta = {
  ...
  radio = callPackage (
    ...
    elpaBuild {
      pname = "radio";
      ename = "radio";
      version = "0.3.1.0.20250220.104508";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/radio-0.3.1.0.20250220.104508.tar";
        sha256 = "012klchmhyjh4rmk6nd0jk161zvv73hcxwmpa3lmpdc9amzdpx9s";
      };
      packageRequires = [ ];
      meta = {
  ...
  slime = callPackage (
    ...
    elpaBuild {
      pname = "slime";
      ename = "slime";
      version = "2.31snapshot0.20250218.131229";
      src = fetchurl {
        url = "https://elpa.nongnu.org/nongnu-devel/slime-2.31snapshot0.20250218.131229.tar";
        sha256 = "09fw736xvsfqvgyflhwpi8x75bs1zj006ncq3pvqw1njh08m8br1";
      };
