{ callPackage }:
{
  ...
  colorful-mode = callPackage (
    ...
    elpaBuild {
      pname = "colorful-mode";
      ename = "colorful-mode";
      version = "1.2.0.0.20250225.121200";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/colorful-mode-1.2.0.0.20250225.121200.tar";
        sha256 = "07sbb8b7dply1shidmq7k70s9mf9d4njpgswy98k8v7nhwp33bmp";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  consult = callPackage (
    ...
    elpaBuild {
      pname = "consult";
      ename = "consult";
      version = "2.0.0.20250216.144752";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/consult-2.0.0.20250216.144752.tar";
        sha256 = "0n465mzbyw5pcnri1rqfwma3qg101fcbspkhf1kf6ivvflybnwqr";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  dape = callPackage (
    ...
    elpaBuild {
      pname = "dape";
      ename = "dape";
      version = "0.22.0.0.20250223.195720";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/dape-0.22.0.0.20250223.195720.tar";
        sha256 = "08mzflvagjkqx8npwf2ng8bz55bc7ir3whxq7c8slvd9nrx22bhk";
      };
  ...
  debbugs = callPackage (
    ...
    elpaBuild {
      pname = "debbugs";
      ename = "debbugs";
      version = "0.43.0.20250225.140711";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/debbugs-0.43.0.20250225.140711.tar";
        sha256 = "1ndc7x2pqmc9yw7qf8x8vnqggng9nwcvdihvp0f33i6m9lmdf9hp";
      };
  ...
  eldoc = callPackage (
    ...
    elpaBuild {
      pname = "eldoc";
      ename = "eldoc";
      version = "1.15.0.0.20250228.13027";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/eldoc-1.15.0.0.20250228.13027.tar";
        sha256 = "036j8hlv4hs0rzsrqz8y15cha5qkbaspqw3y997kk1flqa5802h9";
      };
      packageRequires = [ ];
      meta = {
  ...
  hiddenquote = callPackage (
    ...
    elpaBuild {
      pname = "hiddenquote";
      ename = "hiddenquote";
      version = "1.2.0.20250225.91246";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/hiddenquote-1.2.0.20250225.91246.tar";
        sha256 = "0sssdq921y71p8rdg3550drgr4ns5dd14nwwa0a1a67wzic6dx6g";
      };
      packageRequires = [ ];
      meta = {
  ...
  indent-bars = callPackage (
    ...
    elpaBuild {
      pname = "indent-bars";
      ename = "indent-bars";
      version = "0.8.2.0.20250223.224444";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/indent-bars-0.8.2.0.20250223.224444.tar";
        sha256 = "1fhnhqz8hppnsc4cgq0qiwgc0bns7xvq1s79arp4hm2wb94lv4m4";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  jinx = callPackage (
    ...
    elpaBuild {
      pname = "jinx";
      ename = "jinx";
      version = "1.12.0.20250219.33530";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/jinx-1.12.0.20250219.33530.tar";
        sha256 = "06klpbx45ga01p137j603qmhxcg38lamclq8yznszzf0pk60f5sh";
      };
      packageRequires = [ compat ];
      meta = {
  ...
  llm = callPackage (
    ...
    elpaBuild {
      pname = "llm";
      ename = "llm";
      version = "0.23.0.0.20250301.191836";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/llm-0.23.0.0.20250301.191836.tar";
        sha256 = "0adnsfb3w9d3si4lv60yfvccdqyzx0s4jqgah79m14y2p2v43jzs";
      };
      packageRequires = [
        plz
        plz-event-source
  ...
  project = callPackage (
    ...
    elpaBuild {
      pname = "project";
      ename = "project";
      version = "0.11.1.0.20250213.1457";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/project-0.11.1.0.20250213.1457.tar";
        sha256 = "05gh7ry3p4qzsda27cq4aigg87yi8acp1f5s8dkk2wvm1ycgaxs3";
      };
  ...
  python = callPackage (
    ...
    elpaBuild {
      pname = "python";
      ename = "python";
      version = "0.28.0.20250302.44027";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/python-0.28.0.20250302.44027.tar";
        sha256 = "18clpvhy7qnq2zbhzrsmp4j087p7h6vj2m7ym4g0f9zrnp0zfl64";
      };
      packageRequires = [
        compat
        flymake
  ...
  show-font = callPackage (
    ...
    elpaBuild {
      pname = "show-font";
      ename = "show-font";
      version = "0.2.1.0.20250212.65316";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/show-font-0.2.1.0.20250212.65316.tar";
        sha256 = "06y9fjdw7mnckawb2zssy43m6j1cwcwxm439r7vn2wmy7vk3mvii";
      };
      packageRequires = [ ];
      meta = {
  ...
  transient = callPackage (
    ...
    elpaBuild {
      pname = "transient";
      ename = "transient";
      version = "0.8.5.0.20250301.221818";
      src = fetchurl {
        url = "https://elpa.gnu.org/devel/transient-0.8.5.0.20250301.221818.tar";
        sha256 = "137nk1k1a5hnq06xy4g4q0dyd29b21dcdjh9xaa8r0ki23rszhzi";
      };
      packageRequires = [
        compat
        seq
